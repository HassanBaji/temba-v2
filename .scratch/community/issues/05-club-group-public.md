...
**What to build:** Owner or Admin create a Club Group Public inside a Community with padel (no sport field in the App), and are members of it. Community members join that Club Group with no extra request. Outsiders cannot join. Members cannot create Club Groups. Leaving the Group leaves the User in the Community.
...
- [ ] Owner or Admin can create a Club Group Public with a name and public type only; the App stores padel; the creator is a Group member
- [ ] Club Group create has no sport field
- [ ] Create from the App is refused if padel is not on the allow-list; tRPC still refuses any sport not on the allow-list
