            ...
            <section className="space-y-4">
              <div>
                ...
                <p className="text-body text-muted-foreground mt-1">
                  Owner and Admin can look up an existing User by username,
                  email, or phone and send a Lookup invite. The invitee accepts
                  on Invites. Lookup invites do not expire.
                </p>
              </div>
              <form
